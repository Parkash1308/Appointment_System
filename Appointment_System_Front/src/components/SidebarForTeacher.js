...
import contact from '../SVGs/contact.png'
        ...
        <>
            <div className='bg-white sidebar p-2'>
                ...
                <div className='list-group list-group-flush'>
                    ...
                    <a className='list-group-item py-2'>
                        <img src={contact} alt="A log of Appointments" className='me-3 fs-3' />
                        <span className='fs-9'><Link to="/new-request" >New Requests </Link> </span>
                    </a>
